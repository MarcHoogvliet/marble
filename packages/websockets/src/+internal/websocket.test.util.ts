...
} from '../server/websocket.server.interface';
...
export const bootstrapWebSocketClient = (
...
export const createWebSocketServerMock = (
  clients: ReturnType<typeof createWebSocketClientMock>[]
): WebSocketServerConnection => {
  class WebSocketServerMock extends WebSocket.EventEmitter {
    constructor(
      public clients: ReturnType<typeof createWebSocketClientMock>[]
    ) {
      super();
    }
  }
